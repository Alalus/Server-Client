...
public class Reactor<T> implements Server<T> {
    ...
    /*package*/ void updateInterestedOps(SocketChannel chan, int ops) { // change the interested ops of the channel
        final SelectionKey key = chan.keyFor(selector);
        // if the thread that called this function is the selector thread, then we can change the interested ops of the channel.
        // else, we add a task to the selectorTasks queue and wake up the selector thread
